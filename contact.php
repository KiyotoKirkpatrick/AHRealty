	  ...
	  <div class="row mainInfo">
		<div class="col-md-12">
		  <div class="row">
			...
			<div class='col-md-8'>
			  <h2 class='greenTitle centered bordered'><strong>Contact</strong></h2>
			</div><!-- /.col-md-8 -->
			<div class='col-md-2'></div>
			  <div class="col-md-6">
				<div class='content'>
				  <p><h3 class='orangeTitle'>General Information</h3></p>
				  <p><h5>AH Realty Advisors, LLC
				  <br>330 North Fourth Street, Suite 300
				  <br>Saint Louis, MO  63102
				  <br>
				  <br>Hours:  Mon-Fri  8:30am - 5pm
				  <br>
				  <br><span class="orangeText">P</span> 314.773.1700
				  <br><span class="orangeText">F</span> 314.449.8256
				  <br><a class='emailButton greenTitle' href="javascript:;">info@ahrealtyadvisors.com</a>
				  </h5></p>
					  <p><h3 class='orangeTitle'>Brokerage Services</h3></p>
				  <p><h5>Rob Berneking
				  <br><span class="orangeText">P</span> 314.733.1700 x303
				  <br><a class='emailButton greenTitle' href="javascript:;">rob@ahrealtyadvisors.com</a>
				  </h5></p>
				  <p><h3 class='orangeTitle'>Property Management &amp; Development</h3></p>
				  <p><h5>Christian Andrade
				  <br><span class="orangeText">P</span> 314.733.1700 x302
				  <br><a class='emailButton greenTitle' href="javascript:;">christian@ahrealtyadvisors.com</a>
				  </h5></p>
				</div>
			  </div><!-- /.col-md-6 -->
			<div class="col-md-6">
			  <div class='content'>
				<h3 class='orangeTitle'>Careers</h3>
				<h5><strong>AH Realty Advisors, LLC</strong> is looking for talented commercial real estate agents.
				<br><br>If you are interested in employment, please send a resume and cover letter to Christian Andrade.
				<br><br><a class='emailButton greenTitle' href="javascript:;">christian@ahrealtyadvisors.com</a></h5>
			  </div>
			</div><!-- /.col-md-6 -->
		  </div><!-- /.row -->
		</div><!-- /.col-md-12 -->
