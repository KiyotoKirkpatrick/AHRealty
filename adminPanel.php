...
================================================== -->
    ...
    <div class="container marketing">
        ...
        <div class="col-md-12">
            <div class="row">
                <div class='col-md-12'>
                    <h2 class='greenTitle centered bordered'><strong>Admin Panel</strong></h2>
                </div><!-- /.col-md-8 -->
                ...
                <div class="col-md-6 col-md-offset-3 loggedIn bordered">
                    <div class='content'>
                        ...
                        <?php if ($logged == "in") : ?>
                        	...
                        	<p><a href="adminPaneldz" class="loginButton">Post a Listing</a></p>
                        	<p><a href="adminProperties" class="loginButton">Edit Listings</a></p>
                        	<p><a href="register" class="loginButton">Register a New User</a></p>
                            <p><a href="change" class="loginButton">Change Your Password</a></p>
