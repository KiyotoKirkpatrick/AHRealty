...
================================================== -->
    ...
    <div class="container marketing">
        ...
        <div class="col-md-12">
            <div class="row">
                <div class='col-md-12'>
                    <h2 class='greenTitle centered bordered'><strong>Registration Form</strong></h2>
                </div><!-- /.col-md-8 -->
                <div class="col-md-6 col-md-offset-3">
                    <div class='content'>
                        ...
                        <?php if ($logged == "in") : ?>
                            ...
                            <h1><span class="orangeTitle">To Register A New User:</span></h1>
                            ...
                            <form method="post" name="registration_form" action="">
                                <h3><span class="orangeTitle">Username:</span></h3><input type='text' name='username' id='username' /><br>
                                <h3><span class="orangeTitle">Email:</span></h3><input type="text" name="email" id="email" /><br>
                                <h3><span class="orangeTitle">Password:</span></h3><input type="password"
                                                 name="password"
                                                 id="password"/><br>
                                <h3><span class="orangeTitle">Confirm password:</span></h3><input type="password"
                                                         name="confirmpwd"
                                                         id="confirmpwd" /><br>
                                <input type="button"
                                       value="Register"
