  ...
  <body>
	...
	<div class="container marketing">
	  ...
	  <div class="row mainInfo">
		<div class="col-md-8">
		  <h2 class='greenTitle centered bordered'><strong>AH Realty Advisors Services</strong></h2>
		  <div class='content'>
			<p>At <strong>AHRA</strong> we understand that our clients' goals differ substantially, so we offer a wide range of services to meet those needs. Although the scope of services varies, our dedication to achieving our clients' goals remains unwavering.</p>
			<p><br><h5>Our range of services includes:</p>
			...
			<br>
			<p>Should you have any general questions about the services we provide, please contact <strong>Christian Andrade</strong> at 314.773.1700 x302 or <a class='emailButton greenTitle' href="javascript:;">christian@ahrealtyadvisors.com</a></p></h5>
		  </div>
		</div><!-- /.col-md-8 -->
