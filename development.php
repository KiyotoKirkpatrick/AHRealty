  ...
  <body>
	...
	<div class="container marketing">
	  ...
	  <div class="row mainInfo">
		<div class="col-md-8">
		  <h2 class='greenTitle centered bordered'><strong>Property Development</strong></h2>
		  <div class='content'>
		  <p>Development can be a complicated process involving many different specialties and professions. Putting together a experienced and knowledgeable team is critical to the success of any project. Moreover, this process requires constant attention to ensure that the project is completed on time and on budget. <strong>AHRA</strong> can coordinate the entire development process and avoid costly errors.</p>
			  <p><h5><strong>Please find below a list of our development services:</p>
			  <ul>
				<li>Fee Based Development</li>
				<li>Project Management</li>
				<li>Tenant Build-Out Management</li>
				<li>Capital Improvement/Rehabilitation Management</li>
			  </ul><h5></strong>
			  <p>Please contact <strong>Christian Andrade</strong> at 314.773.1700 x302 or <a class='emailButton greenTitle' href="javascript:;">christian@ahrealtyadvisors.com</a> for more information.</p></h5>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-body">
            <form class="contact" name="contact">
				...
				<h4><input type="text" id="mailSubject" name="subject" class="form-control" value="Development"></h4>
