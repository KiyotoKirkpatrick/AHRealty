...
================================================== -->
	...
	<div class="container marketing">
		...
		<div class="col-md-12">
			<div class="row">
				<div class='col-md-12'>
					<h2 class='greenTitle centered bordered'><strong>Login</strong></h2>
				</div><!-- /.col-md-8 -->
				<div class="col-md-6 col-md-offset-3">
					<div class='content'>
						...
						if (isset($_GET['error'])) {
							...
							if ($errorMessage == 1) {
								echo "<script type='text/javascript'>alert('Error Logging In.\\nPlease try again.');</script>";
							}
						}
					    ...
					    <?php else : ?>
					    	<form action="includes/process_login" method="post" name="login_form">
								<h3><span class="orangeTitle">Email: </span></h3><input type="text" name="email" id="email" />
								<h3><span class="orangeTitle">Password: </span></h3><input type="password"
												 name="password"
												 id="password"/>
								<span><input type="button"
										 value="Login"
										 id="loginButton"
										 onclick="formhash(this.form, this.form.password);" class="loginButton"/>
								</span>
							</form>
							<h4>If you don't have a login, please have a registered user <a href="register">Register You</a> while logged in.</h4>
					    <?php endif; ?>
					</div>
				</div><!-- /.col-md-6 -->
			</div><!-- /.row -->
