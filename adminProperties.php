...
================================================== -->
  <body>
			...
			<div class='row'>
			  <div class='col-md-6 borderedSorts'>
				<h3 class='centered' id='sortBy'>
					...
					<li class="dropdown adminButton">
						<a href="#adminType" class="dropdown-toggle" data-toggle="dropdown">Admin <b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li class="dropdown-submenu displayButton active">
								<a href="javascript:;" tabindex="-1">Displayed</a>
								<ul class="dropdown-menu">
									<li class="publicButton active"><a href="javascript:;">Public</a></li>
									<li class="divider"></li>
									<li class="internalButton"><a href="javascript:;">Internal</a></li>
									<li class="divider"></li>
									<li class="allDisplayedButton"><a href="javascript:;">All</a></li>
								</ul>
							</li>
							<li class="divider"></li>
							<li class="featuredButton"><a href="javascript:;">Featured</a></li>
							<li class="activeButton"><a href="javascript:;">Active</a></li>
							<li class="leasedButton"><a href="javascript:;">Leased</a></li>
							<li class="soldButton"><a href="javascript:;">Sold</a></li>
						</ul>
					</li>
				</h3>
			  </div>
	...
	<script src="scripts/searchAdminProperties.js"></script>
