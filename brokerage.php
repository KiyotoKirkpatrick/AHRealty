	...
	<body>
							...
							<ul class="nav navbar-nav navbar-right">
								...
								<li class="dropdown active">
									...
									<ul class="dropdown-menu">
										<li class="active"><a href="brokerage">Brokerage</a></li>
										<li><a href="management">Management</a></li>
										<li><a href="development">Development</a></li>
										<li><a href="consulting">Consulting</a></li>
									</ul>
								</li>
								<li class="dropdown"><a href="#properties" class="dropdown-toggle" data-toggle="dropdown">Properties <b class="caret"></b></a>
									<ul class="dropdown-menu">
		...
		<div class="container marketing">
			...
			<div class="row mainInfo">
				<div class="col-md-8">
				<h2 class='greenTitle centered bordered'><strong>Brokerage</strong></h2>
				<div class='content'>
					<p>The mantra in real estate is location, location location. Though that is true, when you are choosing a broker to assist in your real estate needs, it should be service, service, service. Brokerage is more than sticking a sign in the ground and presenting offers or proposals. Every real estate assignment presents unique challenges and you need an advisor with a strong commitment to service and the experience to over come those challenges. When you select AHRA, you are getting is an advisor dedicated to your success.</p>
					<p><br><h5><strong>We offer a range of representation types, including:</p>
					<ul>
						<li>Landlord</li>
						<li>Tenant</li>
						<li>Buyer</li>
					...
					<p>In addition, we cover a variety of property types, including:</p>
					<ul>
						<li>Retail</li>
						<li>Office</li>
						<li>Multifamily</li>
					...
					<p><br>
						For more information on regarding our brokerage services please contact <strong>Rob Berneking</strong> at 314.773.1700 x303 or <a class='emailButton greenTitle' href="javascript:;">rob@ahrealtyadvisors.com</a>
					</p></h5>
				</div>
				...
				<div class="modal-dialog">
					...
					<div class="modal-body">
						<form class="contact" name="contact">
							...
							<h4><input type="text" id="mailSubject" name="subject" class="form-control" value="Brokerage"></h4>
