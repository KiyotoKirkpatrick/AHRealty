  ...
  <body>
	...
	<div class="container marketing">
	  ...
	  <div class="row mainInfo">
		<div class="col-md-8">
		  <h2 class='greenTitle centered bordered'><strong>Real Estate Consulting</strong></h2>
		  <div class='content'>
			<h5><p>Many times clients will need services that do not fall into the traditional brokerage or property management functions. In order to meet these needs, we offer a wide range of consulting services including:</p>
			<ul><strong>
				<li>Broker Opinion of Value</li>
				<li>Project Financing Advisory</li>
				<li>Property Tax Advisory</li>
				<li>Property Repositioning Strategies</li>
				<li>Sale Versus Rehabilitation Cost Analysis</li>
				<li>Site Analysis</li>
			</ul></strong>
			<p>To inquire about our consulting services please contact <strong>Christian Andrade</strong> at 314.773.1700 x302 or or <a class='emailButton greenTitle' href="javascript:;">christian@ahrealtyadvisors.com</a>
			</p></h4>
		  </div>
				...
				<div class="modal-dialog">
					...
					<div class="modal-body">
						<form class="contact" name="contact">
							...
							<h4><input type="text" id="mailSubject" name="subject" class="form-control" value="Consulting"></h4>
